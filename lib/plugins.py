"""Plugin system for extending Ollama Chat CLI functionality."""
...
class PluginBase(ABC):
    ...
    def get_commands(self) -> Dict[str, Callable]:
        """Return dictionary of command_name: command_function."""
        pass
    ...
    def on_command_executed(self, command: str, args: List[str]) -> None:
        """Called when a command from this plugin is executed."""
        pass
...
'''
    ...
    def load_plugin(self, plugin_name: str) -> bool:
        ...
        try:
            ...
            if not plugin_class:
                console.print(
                    f"[red]No valid plugin class found in {plugin_file}[/red]"
                )
                return False
            ...
            console.print(
                f"[green]✓ Loaded plugin:[/green] [white]{plugin_name}[/white]"
            )
            return True
    ...
    def unload_plugin(self, plugin_name: str) -> bool:
        ...
        try:
            ...
            console.print(
                f"[green]✓ Unloaded plugin:[/green] [white]{plugin_name}[/white]"
            )
            return True
    ...
    def list_plugins(self) -> None:
        ...
        table = Table(
            title="🔌 Loaded Plugins", show_header=True, header_style="bold blue"
        )
        ...
        for plugin_name, plugin in self.plugins.items():
            ...
            table.add_row(
                plugin_name, plugin.version, plugin.description, commands or "None"
            )
    ...
    def list_available_plugins(self) -> None:
        ...
        for plugin_name in discovered:
            ...
            table.add_row(
                plugin_name, f"[{status_style}]{status}[/{status_style}]", description
            )
